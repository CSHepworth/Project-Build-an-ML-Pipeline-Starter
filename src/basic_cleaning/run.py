...
def go(args):
    ...
    idx = df["longitude"].between(-74.25, -73.60) & df["latitude"].between(40.5, 41.2)
    df = df[idx].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "Description of the cleaned sample",
        required = True
    )
